...
fileID = fopen('/media/janvijay/587A4D997A4D74B2/Code/client_test_face.txt');
...
fileID = fopen('client_test_face_features.txt','w');

for i=1:length(fNames) 
fName = fNames(i);
fPath = strcat('/media/janvijay/224A23DA4A23AA0D/Documents and Settings/Janvijay/Downloads/Compressed/Detectedface/Detectedface/ClientFace/',strrep(fName,'\','/') );    
% disp(fPath);
% z = 'ramu';
% class(fPath{1})
